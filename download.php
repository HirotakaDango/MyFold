...
// Function to fetch and process images from the API
function process_images($api_url, $save_dir, $rename_files) {
...
$api_url = $base_url . "/api.php?uid=$uid";
process_images($api_url, $save_dir, $rename_files);
?>
